...
LATEX_SYMBOL_OVERRIDES = {
    ...
    'OUTPUT_D_DATA_FORMAT': r'\mathrm{Fmt^{(matD)}}',
    'M': r'\mathrm{M_dim}',
    'K': r'\mathrm{K_dim}',
    'N': r'\mathrm{N_dim}',
    'OUTPUT_BYTES_PER_ELEMENT_FP32': r'\mathrm{Byte_{pElement}^{(D)}}',
    ...
    'TOTAL_L2_SIZE_B_FOR_A_SINGLE_INSTANCE': r'\mathrm{|L2_Bytes|}',
    ...
    'L2_READ_B_XECORE_CLK': r'\mathrm{L2RdB_{pClk{\cdot}XeCore}}',
    'L2_WRITE_B_XECORE_CLK': r'\mathrm{L2WrB_{pClk{\cdot}XeCore}}',
    'L2_READ_WRITE_B_XECORE_CLK': r'\mathrm{L2RdWrB_{pClk{\cdot}XeCore}}',
    'L1_READ_B_XECORE_CLK': r'\mathrm{L1RdB_{pClk{\cdot}XeCore}}',
    'L1_WRITE_B_XECORECLK': r'\mathrm{L1WrB_{pClk{\cdot}XeCore}}',
    'L1_READ_B_EU_CLK': r'\mathrm{L1RdB_{pClk{\cdot}EU}}',
    'L1_WRITE_B_EU_CLK': r'\mathrm{L1WrB_{pClk{\cdot}EU}}',
    'L2_READ_MAX_B_XECORE_CLK': r'\mathrm{L2RdB_{pClk{\cdot}XeCore}^{(max)}}',
    'L2_WRITE_MAX_B_XECORE_CLK': r'\mathrm{L2WrB_{pClk{\cdot}XeCore}^{(max)}}',
    'L2_READ_WRITE_MAX_B_XECORE_CLK': r'\mathrm{L2RdWrB_{pClk{\cdot}XeCore}^{(max)}}',
    'L2_READ_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2RdB/pClk{\cdot}XeCore}}',
    'L2_WRITE_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2WrB/pClk{\cdot}XeCore}}',
    'L2_READ_WRITE_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2RdWrB/pClk{\cdot}XeCore}}',
    'L1_READ_B_EU_CLK_PCT': r'\mathrm{\eta_{L1RdB/pClk{\cdot}EU}}',
    'L1_WRITE_B_EU_CLK_PCT': r'\mathrm{\eta_{L1WrB/pClk{\cdot}EU}}',

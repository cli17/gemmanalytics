...
def compute_core_values(workload_params: dict, machine_params: dict) -> dict:
    ...
    MMA_MAC_THROUGHPUT_PER_XECORE = (4 / max(INPUT_A_BYTES_PER_ELEMENT, INPUT_B_BYTES_PER_ELEMENT)) * DPAS_DEPTH * 16 * EU_PER_XECORE
...
COMPUTE_ORDER = (
    ...
    ['INPUT_A_BYTES_PER_ELEMENT', 'INPUT_B_BYTES_PER_ELEMENT', 'OUTPUT_BYTES_PER_ELEMENT_AFTER_DOWN_CONVERSION',
     'EU_COUNT', 'MMA_MAC_THROUGHPUT_PER_XECORE', 'CLKS_PER_DPAS',
    ...
    ['CLK_SPECIFIED_EFFICIENCY', 'TOTAL_L2_READ_B', 'TOTAL_L2_WRITE_B', 'TOTAL_L1_READ_B', 'TOTAL_L1_WRITE_B',
...
LATEX_SYMBOL_OVERRIDES = {
    ...
    'OUTPUT_BYTES_PER_ELEMENT_AFTER_DOWN_CONVERSION': r'\mathrm{Bytes_{pElement}^{(matD\downarrow)}}',

...
def compute_core_values(workload_params: dict, machine_params: dict) -> dict:
    ...
    CLK_SPECIFIED_EFFICIENCY = WORKLOAD_MAC_PER_XECORE / (
        MMA_MAC_THROUGHPUT_PER_XECORE * COMPUTE_EFFICIENCY_PCT
    )
...
# Order following statement-by-statement execution order in compute_core_values()
COMPUTE_ORDER = (
    # Section 1: Machine Pre-Defined Parameters (assignment order)
    ['GT_FREQ_GHZ', 'XECU_COUNT', 'XECORE_PER_XECU', 'EU_PER_XECORE', 'L2_BANKS_PER_XECU',
     'BANK_CAPACITY_MB', 'DPAS_DEPTH', 'COMPUTE_EFFICIENCY_PCT',
     'L1_READ_MAX_B_EU_CLK', 'L1_WRITE_MAX_B_EU_CLK', 'GTI_READ_MAX_BW_B_CLK', 'GTI_WRITE_MAX_BW_B_CLK',
     'MAX_POSSIBLE_HBM_BW_GB_S'] +
    # Section 2: Workload Pre-Defined Parameters (assignment order)
    ['INPUT_A_DATA_FORMAT', 'INPUT_B_DATA_FORMAT', 'OUTPUT_D_DATA_FORMAT',
     'M', 'K', 'N', 'OUTPUT_BYTES_PER_ELEMENT_FP32', 'MACHINE_OCCUPANCY_PCT',
     'M_PER_THREAD', 'K_PER_THREAD', 'N_PER_THREAD',
     'TG_WIDTH_IN_UNITS_OF_THREAD', 'TG_HEIGHT_IN_UNITS_OF_THREAD',
     'XECORE_CLUSTER_WIDTH_IN_UNITS_OF_TG_KEEP_THE_CLUSTER_SIZE_AS_4',
     'XECORE_CLUSTER_HEIGHT_IN_UNITS_OF_TG_KEEP_THE_CLUSTER_SIZE_AS_4',
     'XECU_TILE_WIDTH_IN_UNITS_OF_TG', 'XECU_TILE_HEIGHT_IN_UNITS_OF_TG',
     'GPU_TILE_WIDTH_IN_XECU_UNIT'] +
    ...
    ['INPUT_A_BYTES_PER_ELEMENT', 'INPUT_B_BYTES_PER_ELEMENT', 'OUTPUT_BYTES_PER_ELEMENT_AFTER_DOWN_CONVERSION',
     ...
     'XECORE_CLUSTER_WIDTH_IN_UNITS_OF_ELEMENT', 'TG_CLUSTER_TILES_IN_N',
     'XECORE_CLUSTER_HEIGHT_IN_UNITS_OF_ELEMENT', 'TG_CLUSTER_TILES_IN_M',
     'XECU_TILE_WIDTH_IN_UNITS_OF_ELEMENT', 'XECU_TILES_IN_N', 'GPU_TILES_IN_N',
     'XECU_TILE_HEIGHT_IN_UNITS_OF_ELEMENT', 'XECU_TILES_IN_M',
     'GPU_TILE_HEIGHT_IN_XECU_UINT', 'GPU_TILES_IN_M', 'WAVES',
     'GPU_TILE_WIDTH_IN_UNITS_OF_ELEMETNS', 'GPU_TILE_HEIGHT_IN_UNITS_OF_ELEMETNS',
     'MAT_A_INPUT_SIZE_B', 'MAT_B_INPUT_SIZE_B', 'MAT_C_INPUT_D_OUTPUT_SIZE_B', 'MAT_D_INTERMEDIATE_SIZE_B',
     'TOTAL_L2_SIZE_B_FOR_A_SINGLE_INSTANCE',
     'WORKING_DATA_SET_SIZE_OF_K_IN_L2_CORRESP_20K_CLOCKS_OF_THREAD_DIVERGENCE',
     'TOTAL_REQUIRED_L2_SIZE_FOR_IDEAL_HIT_RATE_B_FOR_A_SINGLE_INSTANCE_AND_SINGLE_WAVE',
     'MAX_POSSIBLE_HBM_BW_FREQ_B_CLK'] +
    # Section 4: Machine Stats (statement execution order)
    ['WORKLOAD_MAC_PER_XECORE', 'CLK_SPECIFIED_EFFICIENCY', 'TOTAL_L2_READ_B', 'TOTAL_L2_WRITE_B', 'TOTAL_L1_READ_B', 'TOTAL_L1_WRITE_B',
     'L2_READ_B_XECORE_CLK', 'L2_WRITE_B_XECORE_CLK', 'L2_READ_WRITE_B_XECORE_CLK',
     'L1_READ_B_EU_CLK', 'L1_READ_B_XECORE_CLK', 'L1_WRITE_B_EU_CLK', 'L1_WRITE_B_XECORECLK',
     'L2_READ_MAX_B_XECORE_CLK', 'L2_WRITE_MAX_B_XECORE_CLK', 'L2_READ_WRITE_MAX_B_XECORE_CLK',
     'L2_READ_B_XECORE_CLK_PCT', 'L2_WRITE_B_XECORE_CLK_PCT', 'L2_READ_WRITE_B_XECORE_CLK_PCT',
     'L1_READ_B_EU_CLK_PCT', 'L1_WRITE_B_EU_CLK_PCT',
     'L2_HIT_RATE_ASSUMED_RANDOM_ACCESS_WITHIN_THE_WORKING_DATA_SET_PCT', 'L2_MISS_RATE_PCT',
     'TOTAL_L2_READ_TRAFFIC_B',
     'PROBABILITY_OF_MATA_HIT_IN_L2_DURING_A_NON_FIRST_WAVE_PCT',
     'PROBABILITY_OF_MATB_HIT_IN_L2_DURING_A_NON_FIRST_WAVE_PCT',
     'PROBABILITY_OF_MATA_MISS_IN_L2_DURING_A_NON_FIRST_WAVE_PCT',
     'PROBABILITY_OF_MATB_MISS_IN_L2_DURING_A_NON_FIRST_WAVE_PCT',
     'TOTAL_HBM_READ_B_AFTER_A_COMPLETION_OF_A_WAVE_CONSIDER_COLD_CACHE',
     'TOTAL_HBM_WRITE_B', 'TOTAL_HBM_B',
     'HBM_READ_B_CLK', 'HBM_WRITE_B_CLK', 'HBM_TOTAL_B_CLK',
...
LATEX_SYMBOL_OVERRIDES = {
    ...
    'XECORE_PER_XECU': r'\mathrm{|XeCore|_{perXeCU}}',
    'EU_PER_XECORE': r'\mathrm{|EU|_{perXeCore}}',
    'L2_BANKS_PER_XECU': r'\mathrm{|L2Banks|_{perXeCU}}',
    'BANK_CAPACITY_MB': r'\mathrm{L2BankSize_{MB}}',
    'DPAS_DEPTH': r'\mathrm{D_{DPAS}}',
    'COMPUTE_EFFICIENCY_PCT': r'\mathrm{\eta_{systolic}}',
    'L1_READ_MAX_B_EU_CLK': r'\mathrm{L1RdBW_{Bp(Clk{\cdot}EU)}^{max}}',
    'L1_WRITE_MAX_B_EU_CLK': r'\mathrm{L1WrBW_{Bp(Clk{\cdot}EU)}^{max}}',
    ...
    'K': r'\mathrm{K_{dim}}',
    'N': r'\mathrm{N_{dim}}',
    'OUTPUT_BYTES_PER_ELEMENT_FP32': r'\mathrm{Byte_{perElement}^{(matD)}}',
    'MACHINE_OCCUPANCY_PCT': r'\mathrm{\rho_{GT}}',
    'M_PER_THREAD': r'\mathrm{M_{perThread}}',
    'K_PER_THREAD': r'\mathrm{K_{perThread}}',
    'N_PER_THREAD': r'\mathrm{N_{perThread}}',
    ...
    'INPUT_A_BYTES_PER_ELEMENT': r'\mathrm{Bytes_{perElement}^{(matA)}}',
    'INPUT_B_BYTES_PER_ELEMENT': r'\mathrm{Bytes_{perElement}^{(matB)}}',
    'OUTPUT_BYTES_PER_ELEMENT_AFTER_DOWN_CONVERSION': r'\mathrm{Bytes_{perElement}^{(matD\downarrow)}}',
...
def build_equations_markdown(output_order: str = 'execution') -> str:
    ...
    # --- Section: Machine Parameters (Pre-Defined) ---
    ...
    lines.append('## Computed Equations')
    lines.append('')
...
PARAM_DESCRIPTIONS = {
    # ---- Machine pre-defined ----
    'GT_FREQ_GHZ': 'GT Freq (GHz)',
    'XECU_COUNT': 'XeCU count',
    'XECORE_PER_XECU': 'XeCore per XeCU',
    'EU_PER_XECORE': 'EU per XeCore',
    'L2_BANKS_PER_XECU': 'L2 banks per XeCU',
    'BANK_CAPACITY_MB': 'bank capacity (MB)',
    'DPAS_DEPTH': 'DPAS depth',
    'COMPUTE_EFFICIENCY_PCT': 'compute efficiency %',
    'L1_READ_MAX_B_EU_CLK': 'L1 read max (B/EU/clk)',
    'L1_WRITE_MAX_B_EU_CLK': 'L1 write max (B/EU/clk)',
    ...
    'OUTPUT_D_DATA_FORMAT': 'output D data format (e.g. fp8)',
    # ---- Workload pre-defined ----
    'M': 'M dimension',
    'K': 'K dimension',
    'N': 'N dimension',
    'OUTPUT_BYTES_PER_ELEMENT_FP32': 'output bytes per element (fp32)',
    'MACHINE_OCCUPANCY_PCT': 'machine occupancy %',
    'M_PER_THREAD': 'M per thread',
    'K_PER_THREAD': 'K per thread',
    'N_PER_THREAD': 'N per thread',
    'TG_WIDTH_IN_UNITS_OF_THREAD': 'TG width in units of thread',
    'TG_HEIGHT_IN_UNITS_OF_THREAD': 'TG height in units of thread',
    'XECORE_CLUSTER_WIDTH_IN_UNITS_OF_TG_KEEP_THE_CLUSTER_SIZE_AS_4': 'XeCore cluster width in units of TG (keep cluster size as 4)',
    'XECORE_CLUSTER_HEIGHT_IN_UNITS_OF_TG_KEEP_THE_CLUSTER_SIZE_AS_4': 'XeCore cluster height in units of TG (keep cluster size as 4)',

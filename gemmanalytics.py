...
LATEX_SYMBOL_OVERRIDES = {
    ...
    'L2_READ_B_XECORE_CLK': r'\mathrm{L2RdB_{p(Clk{\cdot}XeCore)}}',
    'L2_WRITE_B_XECORE_CLK': r'\mathrm{L2WrB_{p(Clk{\cdot}XeCore)}}',
    'L2_READ_WRITE_B_XECORE_CLK': r'\mathrm{L2RdWrB_{p(Clk{\cdot}XeCore)}}',
    'L1_READ_B_XECORE_CLK': r'\mathrm{L1RdB_{p(Clk{\cdot}XeCore)}}',
    'L1_WRITE_B_XECORECLK': r'\mathrm{L1WrB_{p(Clk{\cdot}XeCore)}}',
    'L1_READ_B_EU_CLK': r'\mathrm{L1RdB_{p(Clk{\cdot}EU)}}',
    'L1_WRITE_B_EU_CLK': r'\mathrm{L1WrB_{p(Clk{\cdot}EU)}}',
    'L2_READ_MAX_B_XECORE_CLK': r'\mathrm{L2RdB_{p(Clk{\cdot}XeCore)}^{(max)}}',
    'L2_WRITE_MAX_B_XECORE_CLK': r'\mathrm{L2WrB_{p(Clk{\cdot}XeCore)}^{(max)}}',
    'L2_READ_WRITE_MAX_B_XECORE_CLK': r'\mathrm{L2RdWrB_{p(Clk{\cdot}XeCore)}^{(max)}}',
    'L2_READ_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2RdB/p(Clk{\cdot}XeCore)}}',
    'L2_WRITE_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2WrB/p(Clk{\cdot}XeCore)}}',
    'L2_READ_WRITE_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2RdWrB/p(Clk{\cdot}XeCore)}}',
    'L1_READ_B_EU_CLK_PCT': r'\mathrm{\eta_{L1RdB/p(Clk{\cdot}EU)}}',
    'L1_WRITE_B_EU_CLK_PCT': r'\mathrm{\eta_{L1WrB/p(Clk{\cdot}EU)}}',

...
LATEX_SYMBOL_OVERRIDES = {
    ...
    'GTI_READ_MAX_BW_B_CLK': r'\mathrm{GtiRdBW_{B/clk}^{max}}',
    'GTI_WRITE_MAX_BW_B_CLK': r'\mathrm{GtiWrBW_{B/clk}^{max}}',
    ...
    'K': r'\mathrm{K_dim}',
    'N': r'\mathrm{N_dim}',
    'OUTPUT_BYTES_PER_ELEMENT_FP32': r'\mathrm{Byte_{/element}^{(D)}}',
    'MACHINE_OCCUPANCY_PCT': r'\mathrm{\rho_{GT}}',
    'M_PER_THREAD': r'\mathrm{M_{/thread}}',
    'K_PER_THREAD': r'\mathrm{K_{/thread}}',
    'N_PER_THREAD': r'\mathrm{N_{/thread}}',
    'TG_WIDTH_IN_UNITS_OF_THREAD': r'\mathrm{W_{threads}^{(ThreadGroup)}}',
    'TG_HEIGHT_IN_UNITS_OF_THREAD': r'\mathrm{H_{threads}^{(ThreadGroup)}}',
    ...
    'TG_HEIGHT_IN_UNITS_OF_ELEMENT': r'\mathrm{H_{elements}^{(ThreadGroup)}}',
    'XECORE_CLUSTER_WIDTH_IN_UNITS_OF_ELEMENT': r'\mathrm{W_{elements}^{(XeCoreCluster)}}',
    'XECORE_CLUSTER_HEIGHT_IN_UNITS_OF_ELEMENT': r'\mathrm{H_{elements}^{(XeCoreCluster)}}',
    'XECU_TILE_WIDTH_IN_UNITS_OF_ELEMENT': r'\mathrm{W_{elements}^{(XeCUTile)}}',
    'XECU_TILE_HEIGHT_IN_UNITS_OF_ELEMENT': r'\mathrm{H_{elements}^{(XeCUTile)}}',
    'GPU_TILE_HEIGHT_IN_XECU_UINT': r'\mathrm{H_{XeCU}^{(GPUTile)}}',
    'GPU_TILE_WIDTH_IN_UNITS_OF_ELEMETNS': r'\mathrm{W_{elements}^{(GPUTile)}}',
    'GPU_TILE_HEIGHT_IN_UNITS_OF_ELEMETNS': r'\mathrm{H_{elements}^{(GPUTile)}}',
    'MAT_A_INPUT_SIZE_B': r'\mathrm{Size_{B}^{(A)}}',
    ...
    'MAX_POSSIBLE_HBM_BW_FREQ_B_CLK': r'\mathrm{MemBW_{B/clk}^{max}}',
    'MMA_MAC_THROUGHPUT_PER_XECORE': r'\mathrm{\tau_{MMA mac/clk/XeCore}^{(peak)}}',
    ...
    'L2_READ_B_XECORE_CLK': r'\mathrm{L2RdB_{/clk/XeCore}}',
    'L2_WRITE_B_XECORE_CLK': r'\mathrm{L2WrB_{/clk/XeCore}}',
    'L2_READ_WRITE_B_XECORE_CLK': r'\mathrm{L2RdWrB_{/clk/XeCore}}',
    'L1_READ_B_XECORE_CLK': r'\mathrm{L1RdB_{/clk/XeCore}}',
    'L1_WRITE_B_XECORECLK': r'\mathrm{L1WrB_{/clk/XeCore}}',
    'L1_READ_B_EU_CLK': r'\mathrm{L1RdB_{/clk/EU}}',
    'L1_WRITE_B_EU_CLK': r'\mathrm{L1WrB_{/clk/EU}}',
    'L2_READ_MAX_B_XECORE_CLK': r'\mathrm{L2RdB_{/clk/XeCore}^{(max)}}',
    'L2_WRITE_MAX_B_XECORE_CLK': r'\mathrm{L2WrB_{/clk/XeCore}^{(max)}}',
    'L2_READ_WRITE_MAX_B_XECORE_CLK': r'\mathrm{L2RdWrB_{/clk/XeCore}^{(max)}}',
    'L2_READ_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2RdB/clk/XeCore}}',
    'L2_WRITE_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2WrB/clk/XeCore}}',
    'L2_READ_WRITE_B_XECORE_CLK_PCT': r'\mathrm{\eta_{L2RdWrB/clk/XeCore}}',
    'L1_READ_B_EU_CLK_PCT': r'\mathrm{\eta_{L1RdB/clk/EU}}',
    'L1_WRITE_B_EU_CLK_PCT': r'\mathrm{\eta_{L1WrB/clk/EU}}',
    ...
    'PROBABILITY_OF_MATA_HIT_IN_L2_DURING_A_NON_FIRST_WAVE_PCT': r'\mathrm{P_{L2Hit, after 1st wave}^{(A)}}',
    'PROBABILITY_OF_MATB_HIT_IN_L2_DURING_A_NON_FIRST_WAVE_PCT': r'\mathrm{P_{L2Hit, after 1st wave}^{(B)}}',
    'PROBABILITY_OF_MATA_MISS_IN_L2_DURING_A_NON_FIRST_WAVE_PCT': r'\mathrm{P_{L2Miss, after 1st wave}^{(A)}}',
    'PROBABILITY_OF_MATB_MISS_IN_L2_DURING_A_NON_FIRST_WAVE_PCT': r'\mathrm{P_{L2Miss, after 1st wave}^{(B)}}',
    ...
    'HBM_READ_B_CLK': r'\mathrm{MemRdB_{/clk}}',
    'HBM_WRITE_B_CLK': r'\mathrm{MemWrB_{/clk}}',
    'HBM_TOTAL_B_CLK': r'\mathrm{MemRdWrB_{/clk}}',

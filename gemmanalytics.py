...
LATEX_SYMBOL_OVERRIDES = {
    ...
    'DPAS_DEPTH': '',
    'COMPUTE_EFFICIENCY_PCT': '',
    'L1_READ_MAX_B_EU_CLK': '',
    'L1_WRITE_MAX_B_EU_CLK': '',
    'GTI_READ_MAX_BW_B_CLK': '',
    'GTI_WRITE_MAX_BW_B_CLK': '',
    'MAX_POSSIBLE_HBM_BW_GB_S': '',

    # ---- Workload format keys + pre-defined ----
    'INPUT_A_DATA_FORMAT': '',
    'INPUT_B_DATA_FORMAT': '',
    'OUTPUT_D_DATA_FORMAT': '',
    'M': '',
    'K': '',
    'N': '',
    'OUTPUT_BYTES_PER_ELEMENT_FP32': '',
    'MACHINE_OCCUPANCY_PCT': '',
    'M_PER_THREAD': '',
    'K_PER_THREAD': '',
    'N_PER_THREAD': '',
    'TG_WIDTH_IN_UNITS_OF_THREAD': '',
    'TG_HEIGHT_IN_UNITS_OF_THREAD': '',
    'XECORE_CLUSTER_WIDTH_IN_UNITS_OF_TG_KEEP_THE_CLUSTER_SIZE_AS_4': '',
    'XECORE_CLUSTER_HEIGHT_IN_UNITS_OF_TG_KEEP_THE_CLUSTER_SIZE_AS_4': '',
    'XECU_TILE_WIDTH_IN_UNITS_OF_TG': '',
    'XECU_TILE_HEIGHT_IN_UNITS_OF_TG': '',
    'GPU_TILE_WIDTH_IN_XECU_UNIT': '',
    ...
    'TG_TILES_IN_N': '',
    'TG_TILES_IN_M': '',
    'TG_CLUSTER_TILES_IN_N': '',
    'TG_CLUSTER_TILES_IN_M': '',
    'XECU_TILES_IN_N': '',
    'XECU_TILES_IN_M': '',
    'GPU_TILES_IN_N': '',
    'GPU_TILES_IN_M': '',
    'INPUT_A_BYTES_PER_ELEMENT': '',
    'INPUT_B_BYTES_PER_ELEMENT': '',
    'OUTPUT_BYTES_PER_ELEMENT_AFTER_DOWN_CONVERSION': '',
    'THREAD_WIDTH_IN_UNITS_OF_ELEMENTS': '',
    'THREAD_HEIGHT_IN_UNITS_OF_ELEMENTS': '',
    'TG_WIDTH_IN_UNITS_OF_ELEMENT_REALIZED_BY_MULTIPLE_MMA_ITERATIONS': '',
    'TG_HEIGHT_IN_UNITS_OF_ELEMENT': '',
    'XECORE_CLUSTER_WIDTH_IN_UNITS_OF_ELEMENT': '',
    'XECORE_CLUSTER_HEIGHT_IN_UNITS_OF_ELEMENT': '',
    'XECU_TILE_WIDTH_IN_UNITS_OF_ELEMENT': '',
    'XECU_TILE_HEIGHT_IN_UNITS_OF_ELEMENT': '',
    'GPU_TILE_HEIGHT_IN_XECU_UINT': '',
    'GPU_TILE_WIDTH_IN_UNITS_OF_ELEMETNS': '',
    'GPU_TILE_HEIGHT_IN_UNITS_OF_ELEMETNS': '',
    'MAT_A_INPUT_SIZE_B': '',
    'MAT_B_INPUT_SIZE_B': '',
    'MAT_C_INPUT_D_OUTPUT_SIZE_B': '',
    'MAT_D_INTERMEDIATE_SIZE_B': '',
    'WORKING_DATA_SET_SIZE_OF_K_IN_L2_CORRESP_20K_CLOCKS_OF_THREAD_DIVERGENCE': '',
    'TOTAL_REQUIRED_L2_SIZE_FOR_IDEAL_HIT_RATE_B_FOR_A_SINGLE_INSTANCE_AND_SINGLE_WAVE': '',
    ...
    'TOTAL_L1_READ_B': '',
    'TOTAL_L1_WRITE_B': '',
    'L2_READ_B_XECORE_CLK': '',
    'L2_WRITE_B_XECORE_CLK': '',
    'L2_READ_WRITE_B_XECORE_CLK': '',
    'L1_READ_B_XECORE_CLK': '',
    'L1_WRITE_B_XECORECLK': '',
    'L1_READ_B_EU_CLK': '',
    'L1_WRITE_B_EU_CLK': '',
    'L2_READ_MAX_B_XECORE_CLK': '',
    'L2_WRITE_MAX_B_XECORE_CLK': '',
    'L2_READ_WRITE_MAX_B_XECORE_CLK': '',
    'L2_READ_B_XECORE_CLK_PCT': '',
    'L2_WRITE_B_XECORE_CLK_PCT': '',
    'L2_READ_WRITE_B_XECORE_CLK_PCT': '',
    'L1_READ_B_EU_CLK_PCT': '',
